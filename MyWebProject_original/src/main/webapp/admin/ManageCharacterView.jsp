...
<%
   ...
   if (userRole == null || !userRole.equals("ADMIN")) {
       response.sendRedirect(request.getContextPath() + "/main?message=" + 
           java.net.URLEncoder.encode("관리자 권한이 필요합니다.", "UTF-8") + "&messageType=error");
       return;
   }
%>
<!DOCTYPE html>
...
<body>
   <div class="container">
       ...
       <div class="button-group">
           ...
           <a href="../admin/admin.jsp" class="button admin-button">
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
           ...
           <table class="character-table">
               ...
               <tbody>
                   ...
                   <tr>
                       ...
                       <td>
                           <form action="${pageContext.request.contextPath}/deleteCharacter" method="post" style="display: inline;"
                                 onsubmit="return confirm('정말로 <%= character.getName() %> 캐릭터를 삭제하시겠습니까?\n이 작업은 되돌릴 수 없습니다.');">

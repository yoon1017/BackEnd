...
<%
    ...
    if (userRole == null || !userRole.equals("ADMIN")) {
        ...
        response.sendRedirect(request.getContextPath() + "/Main.jsp?message=" + 
            URLEncoder.encode("관리자 권한이 필요합니다.", "UTF-8") + "&messageType=error");
        return;
    }
%>
<!DOCTYPE html>
    ...
    <main class="content">
        ...
        <div class="admin-container">
            ...
            <div class="admin-section">
                <h2>데이터 관리</h2>
                <div class="admin-grid">
                    <a href="manageCharacters" class="admin-item">
                        <i class="fas fa-database"></i>
                        <span>캐릭터 목록/삭제</span>
                    </a>
                    <a href="admin/AddCharacterView.jsp" class="admin-item">
